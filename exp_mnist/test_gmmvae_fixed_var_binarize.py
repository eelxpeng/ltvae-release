"""
python test_gmmvae.py --lr 0.0001 --lr-stepwise 0.01 --epochs 300 --pretrain model/sdae.pt --save model/gmmvae.pt
On MNIST achieves
...
gmmae.fit(train_loader, test_loader, lr=args.lr, lr_stepwise=args.lr_stepwise, batch_size=args.batch_size,
