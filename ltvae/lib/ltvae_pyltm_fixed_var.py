...
class LTVAE(nn.Module):
    ...
    def updateLatentTree(self, model_file, varNames, setCovariances=True):
    ...
    def fit(self, trainloader, testloader, lr=0.001, stepwise_em_lr = 0.001, batch_size=128, num_epochs=10,
        ...
        lr_stepwise_epoch = stepwise_em_lr
        ...
        for epoch in range(num_epochs):
            ...
            if anneal:
                ...
                lr_stepwise_epoch = adjust_learning_rate(stepwise_em_lr, epoch)
            ...
            for batch_idx, (inputs, labels) in enumerate(trainloader):
                ...
                # stepwise em
                self.latentTree.latObj.stepwise_em_step(z.data.cpu().numpy(), lr_stepwise_epoch, len(inputs), updatevar=False)
